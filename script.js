...
console.log(displayPosition('*Parlux '+'Fragrence Model where I '+ 'Sold cologne and perfume'))
console.log(displayPosition('*fossil '+'Watch Retailer where I ' + 'Sold watches and setting up watch cases'))
console.log(displayPosition('*Appletone '+'Paraprofessional where I '+ 'Assisted children with special needs'))
